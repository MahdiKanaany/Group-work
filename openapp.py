...
while True:
    ...
    elif ("GOOGLE" in p) or ("SEARCH" in p) or ("WEB BROWSER" in p) or ("CHROME" in p) or ("BROWSER" in p) or ("7" in p):
    ...
    elif ("IE" in p) or ("MSEDGE" in p) or ("EDGE" in p) or ("6" in p):
        pyttsx3.speak("Opening")
    ...
    elif ("NOTE" in p) or ("NOTES" in p) or ("NOTEPAD" in p) or ("EDITOR" in p) or ("5" in p):
        pyttsx3.speak("Opening")
    ...
    elif ("PHOTOSHOP" in p) or ("PS" in p) or ("PHOTOSHOP CC" in p) or ("4" in p):
        pyttsx3.speak("Opening")
